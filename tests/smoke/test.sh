...
bash "$INSTALL_SCRIPT" express-tracking "$TARGET_PROJECT"
...
assert_file "$TARGET_PROJECT/.codex/skills/express-tracking/SKILL.md"
assert_file "$TARGET_PROJECT/.codex/skills/express-tracking/.env.example"
assert_file "$TARGET_PROJECT/.codex/skills/express-tracking/agents/openai.yaml"
assert_file "$TARGET_PROJECT/.codex/skills/express-tracking/scripts/run.mjs"
assert_file "$TARGET_PROJECT/.codex/skills/express-tracking/src/run.mjs"
assert_file "$TARGET_PROJECT/.codex/skills/express-tracking/src/config.mjs"
assert_file "$TARGET_PROJECT/.codex/skills/express-tracking/src/carriers.mjs"
assert_file "$TARGET_PROJECT/.codex/skills/express-tracking/src/format.mjs"
assert_file "$TARGET_PROJECT/.codex/skills/express-tracking/src/kuaidi100.mjs"
assert_file "$TARGET_PROJECT/.codex/skills/express-tracking/references/kuaidi100.md"
